...
export const strings = {
    ...
    get detailWhiteboard() { return localize('detail.whiteboard'); },
    get detailWhiteboardContext() { return localize('detail.whiteboardContext'); },
    get detailWhiteboardCanvases() { return localize('detail.whiteboardCanvases'); },
    get detailWhiteboardSubmittedCanvases() { return localize('detail.whiteboardSubmittedCanvases'); },
    ...
    get debugSectionWhiteboard() { return localize('debug.sectionWhiteboard'); },
    ...
    get submitted() { return localize('status.submitted'); },

    // Whiteboard
    get whiteboard() { return localize('whiteboard'); },
    get openWhiteboard() { return localize('openWhiteboard'); },
    get whiteboardContext() { return localize('whiteboardContext'); },
    get whiteboardTitle() { return localize('whiteboardTitle'); },
    get whiteboardSubmitted() { return localize('whiteboardSubmitted'); },
    get whiteboardCancelled() { return localize('whiteboardCancelled'); },
    get whiteboardNewCanvas() { return localize('whiteboardNewCanvas'); },
    get whiteboardDeleteCanvas() { return localize('whiteboardDeleteCanvas'); },
    get whiteboardSubmit() { return localize('whiteboardSubmit'); },
    get whiteboardCancel() { return localize('whiteboardCancel'); },
    get whiteboardUndo() { return localize('whiteboardUndo'); },
    get whiteboardRedo() { return localize('whiteboardRedo'); },
    get whiteboardClear() { return localize('whiteboardClear'); },
    get whiteboardToolPen() { return localize('whiteboardToolPen'); },
    get whiteboardToolHighlighter() { return localize('whiteboardToolHighlighter'); },
    get whiteboardToolRectangle() { return localize('whiteboardToolRectangle'); },
    get whiteboardToolCircle() { return localize('whiteboardToolCircle'); },
    get whiteboardToolLine() { return localize('whiteboardToolLine'); },
    get whiteboardToolArrow() { return localize('whiteboardToolArrow'); },
    get whiteboardToolText() { return localize('whiteboardToolText'); },
    get whiteboardToolEraser() { return localize('whiteboardToolEraser'); },
